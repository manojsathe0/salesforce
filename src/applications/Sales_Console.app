...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <customApplicationComponents>
        ...
        <customApplicationComponent>KnowledgeArticleCounter</customApplicationComponent>
        <customApplicationComponent>Console.BuiltInComponent.mostRecentlyUsed</customApplicationComponent>
        <customApplicationComponent>LeadContactPushNotifications</customApplicationComponent>
    ...
    <pushNotifications>
        <pushNotification>
            <fieldNames>00NG0000008S2O4</fieldNames>
            <objectName>01IG0000001v6VO</objectName>
        </pushNotification>
        <pushNotification>
            <fieldNames>0</fieldNames>
            <objectName>01IG0000001v6VS</objectName>
        </pushNotification>
        <pushNotification>
            <fieldNames>Status__c</fieldNames>
            <objectName>Salesforce_Request__c</objectName>
        </pushNotification>
    </pushNotifications>
    ...
    <workspaceMappings>
        ...
        <mapping>
            <fieldName>Primary_Contact__c</fieldName>
            <tab>Customer_Login__c</tab>
        </mapping>
        <mapping>
            <tab>Home</tab>
